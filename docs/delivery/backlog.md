...
Status: delivery control · Baseline: `design-v4` · Effective: 2026-08-19 · Owner: product delivery council · 55 portfolio epics
...
Identifier namespaces are deliberately distinct: `R0-nn` is research, `F-nn` foundation, `I-nn` intelligence, and `E-nn` experience/pilot. Experiment identifiers are `X01`–`X14`, including the two-stage `X07-A`/`X07-B`; they are never epic identifiers. X13 and X14 are specified in [evaluation](../research/evaluation-and-experiments.md) and [decision intelligence](../research/decision-intelligence-and-deliberation.md); they are not run in this documentation workstream.
...
| R0-06 | Agent ablation X03 | single, critic, specialists; quality/latency/cost statistics; X13 specified as sibling (classed challenge vs critic-only) | T0.10, T6.12 |
...
| R0-15 | Structured challenge experiment X13 | classed challenge vs critic-only on Class C gold; hidden-assumption recall, unjustified-recommendation, termination, cost; specified-not-run until authorised | T0.10, T6.12 |
| R0-16 | Method comparison experiment X14 | MCDA lite vs AHP n≤7 vs BWM; rank stability, stakeholder minutes, automation bias, rank-reversal; specified-not-run until authorised | T0.06, T6.08 |
...
| I-06 | Conflict engine | negation/scope/time/authority/policy-versus-practice types; optional NLI candidate then typed checks; no auto-resolve; SM extensions `under_deliberation`, `dissent_recorded`, `deferred`, `scope_split_pending` | T3.08, T6.04 |
| I-07 | Domain-pack lifecycle | branch, steward review, SHACL-like checks, dependency impact, release/rollback | T3.07, T3.09–T3.10 |
| I-08 | BA model suite | goal, capability, process, rule, data, scenario, requirement, trace, option/MCDA, assumption-map and issue-tree-assist views | T6.04–T6.08 |
| I-09 | Critic and repair | independent checks, fixed budget, escalation; classed challenge only if X13 passes; no default MAFP; controller does not decide | T6.09–T6.11 |
| I-10 | Memory promotion and X08 | consent, evidence, novelty/conflict/freshness gates, poisoning/correction suite | T5.09–T5.10 |
| I-11 | Sufficiency gates | five-way sufficiency; Decision Quality elements mapped to G0–G7 (not a seventh score); never auto-approval | T6.10 |
...
| E-05 | Conflict facilitation | side-by-side claims/evidence, named method/owner, item-level dispositions; no IBIS canvas; Six Hats optional workshop lens only | T3.08, T7.08 |
...
| E-08 | Review/approval/baseline | governed artefact rendering, item-level dispositions, `/reviews` vs `/decisions` split, typed waiver, e-signature, immutable bundle and semantic diff; PRD is a projection | T8.10–T8.12, T9.01–T9.04 |
